  ...
  <div class="bg-[#E8DEF8] dark:bg-[#0F172B] p-4 rounded-lg mb-3 hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          class="w-5 h-5 border-2 border-[#888888] dark:border-gray-500 rounded bg-gray-50 dark:bg-[#0F172B] cursor-pointer flex items-center justify-center select-none relative"
