<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
    ...
    <div class="flex-1 px-4 py-4 pb-32 space-y-3">
      ...
      <div v-for="item in cart.items" :key="item.id" class="bg-[#ECE6F0] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-lg p-4 flex gap-4">
        <!-- Image -->
    ...
    <UButton
        color="neutral"
        variant="solid"
        class="bg-[#70439e] text-white hover:bg-[#5a3380] w-full h-12 rounded-lg flex items-center justify-between px-4"
    >
...
import { useToast } from '#imports' // Для Nuxt. Для Vite: import { useToast } from 'nuxt/app'
