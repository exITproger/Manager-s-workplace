<template>
  <div class="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-48">
    <!-- Шапка -->
    <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-5 mb-6">
      <UButton
        color="gray"
        variant="ghost"
    ...
    <div class="grid grid-cols-4 gap-4 px-4 sm:px-6 lg:px-8 mb-6">
      <div></div>
      <div>
...
// Товары прямо в компоненте (без импорта из data)
const product = {
  id: '100001',
  name: 'iPhone 16 Pro Max',
  price: '129 990',
  quantity: '5',
  image: 'https://via.placeholder.com/176x132?text=iPhone+16'
}
